...
import { userColumns } from "../../datatablesource8";
import UserTable, { userRows } from "../../datatablesource8";
...
const Datatable2 = ({ onCostumeSelect, selectedCostume }) => { // Paso el estado del input como una prop llamada "selectedCostume"
  ...
  const handleSelect = (id, name) => {
    ...
    onCostumeSelect(id, name);
    handleQuantityChange(id, 1); // Establecer la cantidad seleccionada en 1 por defecto
